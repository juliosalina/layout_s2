        ...
        <div class="col-md-12 flex-items-xs-stretch">
            <div class="card card-secondary">
                ...
                <div class="row card-block">
                    ...
                    <div class="col-xs-3 pl-0-md pr-05-md flex-items-xs-middle">
                        <img src="assets/images/users/foto_perfil.jpg" alt="alt-img" class="rounded-circle" width="100" height="100">
                    </div>

                    <div class="col-xs-7 col-md-9 plr-05-md pr-0-lg">
                        <ul class="list-group">
                            <li class="list-group-item"><label>Nome:</label>Bruno Galati</li>
                            <li class="list-group-item"><label>Apelido:</label>Bruno</li>
                            <li class="list-group-item"><label>CPF:</label>123.123.123-12</li>
                            <li class="list-group-item"><label>Dt. Nascimento:</label>04/11/1983 (33 anos)</li>
                            <li class="list-group-item"><label>Tel. Fixo:</label></li>
                            <li class="list-group-item"><label>Tel. Celular:</label>(11) 9815-64900</li>
                            <li class="list-group-item"><label>Email:</label>brngalati@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 flex-items-xs-stretch">
            <div class="card card-inverse card-primary">
                ...
                <div class="card-block">
                    <h4 class="card-title">Em análise</h4>
                    <p class="card-text">Some quick <b>example</b> text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-xs-12 gray-bkg flex-items-xs-middle pr-1 pl-1 pt-05 pb-05 brd-gray-light">
                                <div class="col-md-12 flex-items-xs-stretch">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item"><label>maior:</label>Morbi leo</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 plr-05-md pr-0-lg flex-items-xs-stretch">
                        <div class="col-xs-12 gray-bkg flex-items-xs-middle pr-1 pl-1 pt-05 pb-05 brd-gray-light">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><label>Label maior:</label>Morbi leo risus</li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 flex-items-xs-stretch">
        <div class="col-md-12 flex-items-xs-stretch">
            ...
            <div class="card card-block">
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 text-xs-center flex-items-xs-stretch">
                        <div class="col-md-12 flex-items-xs-stretch">
